...
return(
    <div className='w-full bg-black-90'>
        ...
        <div className='flex justify-between '>
            <div className='w-[30%] mt-16 h-[471px] rounded-lg bg-black-70'>
                <div className='ml-[110px] mt-[10px]'>
                    <img className='w-[150px]  h-[160px]' src={parma}/>
                </div>
                <div className='p-5'>
                    <span className='text-[20px] text-white font-semibold '>Biznesni <br/> tizimlashtirmoqchi <br/> bo'lganlar uchun</span>
                    <p className='text-[16px] text-white font-normal p-4'>
                        Xodimlar uzlariga berilgan <br/> vazifalarni bajarmayaptimi? <br/>
            ...
            <div className='w-[30%] mt-16 h-[471px] rounded-lg bg-black-70'>
                ...
                <div className='p-5'>
                    <span className='text-[20px] text-white font-semibold '>Biznesni <br/> kattalashtirmoqchi bo'lgan<br/> tadbirkorlar uchun</span>
                    <p className='text-[16px] text-white font-normal pt-4'>
                        Moliya bo'limidagi raqamlar <br/> xisoblay olmayapsizmi? <br/>
                        Biznesni kengaytirmoqchimisiz, <br/> lekin xodimlaringiz tayyor emasmi?
                    </p>
                </div>
            </div>
            <div className='w-[30%] mt-16 h-[471px] rounded-lg bg-black-70'>
                ...
                <div className='p-5'>
                    <span className='text-[20px] text-white font-semibold '>Sotuv va mijozlar <br/> bilan muammosi borlar <br/> uchun</span>
                    <p className='text-[16px] text-white font-normal p-4'>
